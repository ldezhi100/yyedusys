...
function funScroll(id, fn) {
    var myScroll;
    function loaded() {
        var ID = document.getElementById(id);


        var offdiv = ID.getElementsByClassName("inaddrbox")[0];
        ...
        myScroll = new iScroll(id, {
            ...
            onScrollEnd: function() {
                fn&& fn();
                // //if (offdiv.clientHeight > ID.clientHeight) {
                // if (offdiv.clientHeight + this.y <= ID.clientHeight) {
                //     fn && fn();
                // }
            }
